...
namespace InternalIssues.Controllers
{
    public class TicketTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId")] TicketType ticketType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId")] TicketType ticketType)
        {
            if (id != ticketType.Id)
            {
                return NotFound();
